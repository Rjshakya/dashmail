/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 5cb723ffae538e38954f63717951e942)
// Runtime types generated with workerd@1.20251210.0 2025-12-13 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/app");
		durableNamespaces: "Threads" | "MailInbox" | "GmailAgent";
	}
	interface Env {
		MAIL_INBOX_KV: KVNamespace;
		APP_URL: string;
		CLIENT_URL: string;
		DB_URL: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
		GOOGLE_PUB_TOPIC: string;
		...
		REDIS_URL: string;
		REDIS_TOKEN: string;
		Threads: DurableObjectNamespace<import("./src/app").Threads>;
		MailInbox: DurableObjectNamespace<import("./src/app").MailInbox>;
		GmailAgent: DurableObjectNamespace<import("./src/app").GmailAgent>;
		DASHMAILBUCKET: R2Bucket;
		EMAIL_QUEUE: Queue;
		HYPERDRIVE: Hyperdrive;
		GenerateMailReportWorkflow: Workflow<Parameters<import("./src/app").GenerateMailReportWorkflow['run']>[0]['payload']>;
		MailScheduleWorkflow: Workflow<Parameters<import("./src/app").MailScheduleWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "CLIENT_URL" | "DB_URL" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GOOGLE_PUB_TOPIC" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "R2_DEV_URL" | "R2_PROD_URL" | "OPENROUTER_API_KEY" | "NODE_ENV" | "CF_ACC_ID" | "CF_AI_GATEWAY_TOKEN" | "CF_KV_API_TOKEN" | "RESEND_API_KEY" | "UNOSEND_API_KEY" | "REDIS_URL" | "REDIS_TOKEN">> {}
}

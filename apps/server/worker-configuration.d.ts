/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 3243d348f9271de6ea1265709dced953)
// Runtime types generated with workerd@1.20251210.0 2025-12-13 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/app");
		durableNamespaces: "MailThreadDO" | "UserMailInboxDO";
	}
	interface Env {
		APP_URL: string;
		CLIENT_URL: string;
		...
		NODE_ENV: string;
		MailThreadDO: DurableObjectNamespace<import("./src/app").MailThreadDO>;
		UserMailInboxDO: DurableObjectNamespace<import("./src/app").UserMailInboxDO>;
		DASHMAILBUCKET: R2Bucket;
		HYPERDRIVE: Hyperdrive;
		SYNC_AND_WATCH_MAIL_INBOX_WORKFLOW: Workflow<Parameters<import("./src/app").SyncAndWatchInboxMailsFlow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "CLIENT_URL" | "DB_URL" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GOOGLE_PUB_TOPIC" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "R2_DEV_URL" | "R2_PROD_URL" | "OPENROUTER_API_KEY" | "NODE_ENV">> {}
}

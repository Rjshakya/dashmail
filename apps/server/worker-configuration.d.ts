/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: e2e650e5fb61f6d139fc7c1f074efecd)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		NODE_ENV: string;
		Mail_Thread: DurableObjectNamespace<import("./src/app").MailThreadDO>;
		User_Mail_Inbox: DurableObjectNamespace<import("./src/app").UserMailInboxDO>;
